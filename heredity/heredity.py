...
def normalize(probabilities):
    ...
    for person in probabilities:
        for type in ['gene', 'trait']:
            ...
            for cate in probabilities[person][type]:
                val = probabilities[person][type][cate]
                normalized_val = val / sums
                normalized[person][type][cate] = normalized_val
    return normalized
